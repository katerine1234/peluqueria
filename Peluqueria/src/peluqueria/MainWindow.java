...
public class MainWindow extends javax.swing.JFrame {
    ...
    public MainWindow() {
        ...
        stylistAna = new Stylist("Ana", 25, "estilista", 1, "cortes Dama", quantityCutsManAna, quantityCutsWomenAna, quantityTinctureAna, quantityHairstyleAna, totalServicesAna, totalCollectionAna, cutManAna, cutWomanAna, dyeHairAna, hairdoAna);
        stylistRoberto = new Stylist("Roberto", 28, "Barbero", 2, "cortes Hombre", quantityCutsManRoberto, quantityCutsWomenRoberto, quantityTinctureRoberto, quantityHairstyleRoberto, totalServicesRoberto, totalCollectionRoberto, cutManRoberto, cutWomanRoberto, dyeHairRoberto, hairdoRoberto);
        stylistJose = new Stylist("Jose", 30, "Barbero", 3, "tinturar cabello", quantityCutsManJose, quantityCutsWomenJose, quantityTinctureJose, quantityHairstyleJose, totalServicesJose, totalCollectionJose, cutManJose, cutWomanJose, dyeHairJose, hairdoJose);
        stylistLucrecia = new Stylist("Lucrecia", 22, "estilista", 4, "peinados", quantityCutsManLucrecia, quantityCutsWomenLucrecia, quantityTinctureLucrecia, quantityHairstyleLucrecia, totalServicesLucrecia, totalCollectionLucrecia, cutManLucrecia, cutWomanLucrecia, dyeHairLucrecia, hairdoLucrecia);
    ...
    private void initComponents() {
        ...
        getContentPane().add(panelStylistJose, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 50, 240, 200));
        ...
        getContentPane().add(panelStylistAna, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 50, 240, 200));
